...
RegisterCommand("acavallo",function(source, args)
	if not piggyBackInProgress then
		...
		if closestPlayer ~= nil then
			...
			print("[Prendi alle spalle] Nessun giocatore nelle vicinanze")
		end
	else
...
RegisterNetEvent('esx_rich_emote:prendiacavallo')
AddEventHandler('esx_rich_emote:prendiacavallo',function()
	if not piggyBackInProgress then
		piggyBackInProgress = true
		local player = PlayerPedId()	
		lib = 'anim@arena@celeb@flat@paired@no_props@'
