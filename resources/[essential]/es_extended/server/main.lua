...
AddEventHandler('esx:giveInventoryItem', function(target, type, itemName, itemCount)
	...
	elseif type == 'item_money' then
		...
		if itemCount > 0 and sourceXPlayer.getMoney() >= itemCount and itemCount < 2000000 then
	...
	elseif type == 'item_account' then
		...
		if itemCount > 0 and sourceXPlayer.getAccount(itemName).money >= itemCount and itemCount < 2000000 then
