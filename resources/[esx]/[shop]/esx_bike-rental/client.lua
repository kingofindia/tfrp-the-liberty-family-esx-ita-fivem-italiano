...
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(1)
		DrawMarker(38, -1036.054, -2734.843, 20.169, 0, 0, 0, 0, 0, 0, 1.5, 1.5, 1.5, 0, 128, 255, 100, false, false, 2, true, 0, 0, false)
	end
end)
...
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(1)
		DrawMarker(38, -240.899, -992.692, 28.889, 0, 0, 0, 0, 0, 0, 1.5, 1.5, 1.5, 0, 128, 255, 100, false, false, 2, true, 0, 0, false)
	end
end)
...
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(1)
		DrawMarker(38, -1262.36, -1438.98, 4.45, 0, 0, 0, 0, 0, 0, 1.5, 1.5, 1.5, 0, 128, 255, 100, false, false, 2, true, 0, 0, false)
	end
end)
...
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(1)
		DrawMarker(38, 1703.601, 3774.294, 34.55, 0, 0, 0, 0, 0, 0, 1.5, 1.5, 1.5, 0, 128, 255, 100, false, false, 2, true, 0, 0, false)
	end
end)
...
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(1)
		DrawMarker(38, 169.857, 6627.238, 31.729, 0, 0, 0, 0, 0, 0, 1.5, 1.5, 1.5, 0, 128, 255, 100, false, false, 2, true, 0, 0, false)
	end
end)
