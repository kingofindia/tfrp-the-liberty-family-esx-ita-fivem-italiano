...
Config.Items = {
    [1] = {label = "Acqua",       item = "water",        price = 3},
    [2] = {label = "Cheeseburger",      item = "bread",       price = 3},
    [3] = {label = "Latte",      item = "milk",       price = 5},
    [4] = {label = "Lemon Soda",      item = "soda",       price = 5},
    [5] = {label = "Birra",      item = "beer",       price = 5},
    [6] = {label = "Hotdog",      item = "hotdog",       price = 5},
    [7] = {label = "Nugets",      item = "nugets",       price = 5},
    [8] = {label = "Caramelle",      item = "candy",       price = 5},
    [9] = {label = "Mangime animali",      item = "croquettes",       price = 5},
    [10] = {label = "Binocolo",      item = "jumelles",       price = 50},
    [11] = {label = "Sigarette",      item = "cigarett",       price = 3},
    [12] = {label = "Fiammiferi",      item = "lighter",       price = 2},
    [13] = {label = "Maschera da sub",      item = "masch",       price = 80},
    [14] = {label = "Manette",      item = "manette",       price = 450},
    [15] = {label = "Fuochi D'Artificio",      item = "firework",       price = 100},
    [16] = {label = "Guantoni",      item = "gloves",       price = 60},
    [17] = {label = "Sacchetto",      item = "headbag",       price = 90},
    [18] = {label = "Saldatrice",      item = "weld",       price = 190},
    [19] = {label = "Trapano",      item = "drill",       price = 190},
}
