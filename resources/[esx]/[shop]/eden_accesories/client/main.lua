...
AddEventHandler('eden_accesories:silencieux', function(duration)
    ...
    local currentWeaponHash = GetSelectedPedWeapon(ped)
		if used < silencieux then
			...
			if currentWeaponHash == GetHashKey("WEAPON_PISTOL") then
		  		 ...
		  		 ESX.ShowNotification(("Hai appena inserito il silenziatore.")) 
		  		 	used = used + 1
	...
	used = used + 1
		  		  ...
		  		  ESX.ShowNotification(("Ti serve un arma oppure l'arma che hai non supporta l'installazione del silenziatore."))
		  		
			end
			else
					  		 ESX.ShowNotification(("Devi utilizzare tutti i silenziatori")) 
...
AddEventHandler('eden_accesories:flashlight', function(duration)
    ...
    local currentWeaponHash = GetSelectedPedWeapon(ped)
		if used2 < flashlight then
			...
			if currentWeaponHash == GetHashKey("WEAPON_PISTOL") then
		  		 ...
		  		 ESX.ShowNotification(("Hai appena inserito una torcia.")) 
		  		 	used2 = used2 + 1
		  	elseif currentWeaponHash == GetHashKey("WEAPON_PISTOL50") then
	...
	used2 = used2 + 1
				...
				ESX.ShowNotification(("Ti serve un arma oppure l'arma che hai non supporta l'installazione della torcia."))
		  		
			end
		else
				  		  ESX.ShowNotification(("Devi utilizzare tutte le torcie."))
...
AddEventHandler('eden_accesories:grip', function(duration)
    ...
    local currentWeaponHash = GetSelectedPedWeapon(ped)
		if used3 < grip then
			...
			if currentWeaponHash == GetHashKey("WEAPON_COMBATPDW") then
		  		 ...
		  		 ESX.ShowNotification(("Hai appena equipaggiato un'impugnatura personalizzata.")) 
		  				used3 = used3 + 1
	...
	used3 = used3 + 1
				...
				ESX.ShowNotification(("Ti serve un arma oppure l'arma che hai non supporta questo accessorio."))
		  		
			end
		else
				  		  ESX.ShowNotification(("Devi utilizzare tutte le impugnature."))
		end
end)
...
AddEventHandler('eden_accesories:yusuf', function(duration)
    ...
    local currentWeaponHash = GetSelectedPedWeapon(ped)
		if used4 < yusuf then
			...
			if currentWeaponHash == GetHashKey("WEAPON_PISTOL") then
		  		 ...
		  		 ESX.ShowNotification(("Hai equipaggiato una skin personalizzata per la tua arma.")) 
		  		 	used4 = used4 + 1
	...
	used4 = used4 + 1
				...
				ESX.ShowNotification(("Ti serve un arma oppure l'arma che hai non supporta questo accessorio."))
				  		  ...
				  		  ESX.ShowNotification(("Devi utilizzare tutte le tue skin."))
