...
function OpenDjMenu()
	local elements = {}
	table.insert(elements, {label = 'Riprendi la musica', value = 'play_music'})
	table.insert(elements, {label = 'Pausa la musica', value = 'pause_music'})
	table.insert(elements, {label = 'Stop la musica', value = 'stop_music'})
