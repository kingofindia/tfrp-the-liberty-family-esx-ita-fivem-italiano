...
function synchone()
	local closeDoor    = GetClosestObjectOfType(-631.9554, -236.3333, 38.20653, 1.0, GetHashKey('p_jewel_door_l'), false, false, false)
	local closeDoor2    = GetClosestObjectOfType(-630.4265, -238.4376, 38.20653, 1.0, GetHashKey('p_jewel_door_r1'), false, false, false)

	SetEntityRotation(closeDoor, 0.0005520837, 0.0006910677, 24.80193, false, true)
	SetEntityRotation(closeDoor2, -0.001213973, -0.0001683295, -132.8037, false, true)
	FreezeEntityPosition(closeDoor, true)
	FreezeEntityPosition(closeDoor2, true)

end

RegisterNetEvent('esx_vangelico_robbery:synchporte')
AddEventHandler('esx_vangelico_robbery:synchporte', function()
	synchone()
end)

RegisterCommand("porte",function(source, args)
        TriggerServerEvent('esx_vangelico_robbery:syncastecazzodeporte')
	TriggerEvent('esx_vangelico_robbery:synchporte')
end, false)

RegisterNetEvent('esx_vangelico_robbery:radio')
AddEventHandler('esx_vangelico_robbery:radio', function()
	TriggerServerEvent("InteractSound_SV:PlayWithinDistance", 25, "gioielleria", 0.3)
end)
