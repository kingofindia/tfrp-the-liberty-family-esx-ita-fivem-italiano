...
RegisterServerEvent('esx_vangelico_robbery:syncastecazzodeporte')
AddEventHandler('esx_vangelico_robbery:syncastecazzodeporte', function()
	local source = source
	local xPlayers = ESX.GetPlayers()
	...
	for i=1, #xPlayers, 1 do
 		...
 		if xPlayer.job.name == 'police' or xPlayer.job.name == 'sceriffo' then
                ...
                TriggerClientEvent('esx_vangelico_robbery:synchporte', xPlayers[i])
				...
				for i=1, #xPlayers, 1 do
					...
					if xPlayer.job.name == 'police' or xPlayer.job.name == 'sceriffo' then
							...
							TriggerClientEvent('esx_vangelico_robbery:setblip', xPlayers[i], Stores[robb].position)
                                                        TriggerClientEvent('esx_vangelico_robbery:radio', xPlayers[i])
					end
