...
function OpenActionMenuInteraction()
	...
	table.insert(elements, {label = 'Metti i vestiti', value = 'ubie'})
	table.insert(elements, {label = 'Togli maglietta', value = 'tul'})
	table.insert(elements, {label = 'Togli Pantaloni', value = 'spo'})
	table.insert(elements, {label = 'Togli scarpe', value = 'but'})
...
RegisterNetEvent('ciao:spogliati')
AddEventHandler('ciao:spogliati', function()
