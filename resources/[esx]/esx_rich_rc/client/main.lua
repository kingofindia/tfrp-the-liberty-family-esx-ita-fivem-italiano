...
function hasPhone (cb)
	...
	ESX.TriggerServerCallback('rcar:getItemAmount', function(qtty)
	  cb(qtty > 0)
	end, 'macchinetta')
end
function ShowNoPhoneWarning () 
	if (ESX == nil) then return end
	ESX.ShowNotification("Non hai una ~r~macchina telecomandata~s~")
end
...
RegisterNetEvent('esx_rich_rc:OpenMenu')
AddEventHandler('esx_rich_rc:OpenMenu', function()
...
RCCar.DrawInstructions = function(distanceCheck)
	...
	local buttonsToDraw = {
		{
			["label"] = "Attiva / disattiva videocamera",
...
--1167.18900000" y="117.45620000" z="79.89860000

name = "Ippodromo"

Citizen.CreateThread(function()
	local blip = AddBlipForCoord(1167.18900000, 117.45620000, 79.89860000)
