...
Config.Zones = {
	...
	ls1 = {
		Pos   = {x = -211.29, y = -1324.004, z = 29.89},
	...
	ls2 = {
		Pos   = {x = -221.595, y = -1330.048, z = 29.89},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
...
Config.Menus = {
	...
	modTransmission = {
		...
		parent = 'upgrades',
		modType = 13,
		price = {5.95, 9.93, 12.51}
	},
	modSuspension = {
		label = _U('suspension'),
		parent = 'upgrades',
		modType = 15,
		price = {3.72, 7.44, 14.88, 19.77, 24.2}
	},
	modArmor = {
		label = _U('armor'),
		parent = 'upgrades',
		modType = 16,
		price = {18.77, 23.28, 34.00, 43.00, 51.00, 60.00}
	},
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
