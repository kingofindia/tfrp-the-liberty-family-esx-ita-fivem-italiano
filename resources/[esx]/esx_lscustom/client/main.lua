...
Citizen.CreateThread(function()
	while true do
		...
		if IsPedInAnyVehicle(playerPed, false) then
			...
			local zone 		  = nil
			local lastZone    = nil
			if (PlayerData.job ~= nil and PlayerData.job.name == 'mecano' and (PlayerData.job.grade_name == 'experimente' or PlayerData.job.grade_name == 'chief' or PlayerData.job.grade_name == 'boss')) or Config.IsMecanoJobOnly == false then
