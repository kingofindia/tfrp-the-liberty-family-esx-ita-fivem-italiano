...
function ShowNoPhoneWarning () 
  ...
  ESX.ShowNotification("Non hai il ~r~telefono~s~")
end
...
RegisterNetEvent('esx_rich_gcphone:OpenForce')
AddEventHandler('esx_rich_gcphone:OpenForce', function()
  hasPhone(function (hasPhone)
    if hasPhone == true then
      TooglePhone()
      aperto = true
...
RegisterNetEvent("gcPhone:apriTelfono")
AddEventHandler("gcPhone:apriTelfono", function()
...
AddEventHandler("gcPhone:receiveMessage", function(message)
  ...
  if message.owner == 0 then
    ...
    if ShowNumberNotification == true then
      text = '~o~Nuovo messaggio da ~y~'.. message.transmitter
