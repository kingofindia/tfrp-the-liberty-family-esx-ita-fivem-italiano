...
Config.ATMS = {
  ...
  {x = 68.861, y = -1745.468, z = 0.844},
  {x = -2240.764, y = -611.686, z = 13.875},
  {x = 2682.872, y = 3286.822, z = 55.241},
}
...
Config.Zones = {
  Tabacchi = {
    Items = {},
      Pos = {
      {x = -56.98,   y = -1752.132,  z = 29.421},
      {x = 174.6720,  y = 6637.218,  z = 31.784},
      {x = 1735.114,   y = 6411.035, z = 35.164},
      {x = -526.416,   y = -1222.953, z = 18.455},
      {x = 1967.333,   y = 3744.293, z = 32.272},
      {x = 2564.399,   y = -469.886, z = 38.016},
      {x = 1139.018,   y = 2585.100, z = 66.789},
      {x = -1827.04,   y = 785.5159, z = 138.020},
      {x = 146.802,   y = -1035.442, z = 29.344},
      {x = -2975.106,   y = 380.1, z = 14.999}
      }
    }
}
