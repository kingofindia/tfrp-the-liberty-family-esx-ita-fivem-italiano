...
TriggerEvent('esx_phone:registerNumber', 'tequila', _U('bahama_mamas_customer'), true, true)
TriggerEvent('esx_society:registerSociety', 'tequila', 'tequila', 'society_tequila', 'society_tequila', 'society_tequila', {type = 'private'})



RegisterServerEvent('esx_dex_tequila:getStockItem')
AddEventHandler('esx_dex_tequila:getStockItem', function(itemName, count)
...
ESX.RegisterServerCallback('esx_dex_tequila:getStockItems', function(source, cb)
...
RegisterServerEvent('esx_dex_tequila:putStockItems')
AddEventHandler('esx_dex_tequila:putStockItems', function(itemName, count)
...
RegisterServerEvent('esx_dex_tequila:getFridgeStockItem')
AddEventHandler('esx_dex_tequila:getFridgeStockItem', function(itemName, count)
...
ESX.RegisterServerCallback('esx_dex_tequila:getFridgeStockItems', function(source, cb)
...
RegisterServerEvent('esx_dex_tequila:putFridgeStockItems')
AddEventHandler('esx_dex_tequila:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('esx_dex_tequila:buyItem')
AddEventHandler('esx_dex_tequila:buyItem', function(itemName, price, itemLabel)
...
RegisterServerEvent('esx_dex_tequila:craftingCoktails')
AddEventHandler('esx_dex_tequila:craftingCoktails', function(itemValue)
...
ESX.RegisterServerCallback('esx_dex_tequila:getVaultWeapons', function(source, cb)
...
ESX.RegisterServerCallback('esx_dex_tequila:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_dex_tequila:removeVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_dex_tequila:getPlayerInventory', function(source, cb)
