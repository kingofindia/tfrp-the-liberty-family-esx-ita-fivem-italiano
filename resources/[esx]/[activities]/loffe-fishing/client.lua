...
local Locations = {
    ...
    ["Blips"] = {
        ...
        ["BuyEquipment"] = {
            name = "Negozio attrezzatura da pesca",
            ["title"] = "Negozio attrezzatura da pesca",
            ["sprite"] = 52,
    ...
    ["Markers"] = {
        ["FishingLocation1"] = { ["x"] = -1741.82, ["y"] = -1129.24, ["z"] = 12.17, ["Info"] = "[E] ~g~Pesca" },
        ["FishingLocation2"] = { ["x"] = -1743.83, ["y"] = -1131.65, ["z"] = 12.17, ["Info"] = "[E] ~g~Pesca" },
        ["FishingLocation3"] = { ["x"] = -1739.94, ["y"] = -1126.98, ["z"] = 12.17, ["Info"] = "[E] ~g~Pesca" },
        ["SellFish"] = { ["x"] = -1845.28, ["y"] = -1195.79, ["z"] = 18.33, ["Info"] = "[E] ~g~Vendi pesce" },
        ["BuyEquipment"] = { ["x"] = -1340.6, ["y"] = -1266.57, ["z"] = 4.05, ["Info"] = "[E] ~g~Acquista attrezzatura da pesca" }
    }
}
...
Citizen.CreateThread(function()
    ...
    for spot, val in pairs(Blips) do
        ...
        AddTextComponentString(tostring(BlipInformation.name))
    ...
    if hasRod and hasBait then
        Citizen.CreateThread(function()
            ...
            while Fishing do
                ...
                if FishOnBait then
                    ESX.Game.Utils.DrawText3D({ x = coords.x, y = coords.y, z = coords.z }, '[INVIO] Prendi il pesce', 0.4)
        ...
        ESX.ShowNotification('Purtroppo non hai abbastanza materiale per pescare')
        return
    end
end
...
function OpenFishMenu()
    ...
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'fish_menu',
        {
            ...
            elements = {
				{label = 'Canna da pesca x 1 [1500 $]', item = 'fiskespo', price = 1500, amount = 1},
				{label = 'Esca x 1 [5 $]', item = 'bait', price = 5, amount = 1},
				{label = 'Esca x 25 [100 $]', item = 'bait', price = 100, amount = 25},
            }
        },
        function(data, menu)
