...
-- POLICE
Config.PoliceNumberRequired = 2    --Set how many cops is need to try stole a car. (0-64)
...
Config.PawnShopBLJob     = {	 --Here you can add job can't sell car at PawnShop
	{ JobName  = "police", },
	{ JobName  = "mecano", },	--new name of job esx_org/esx_mecahnicjob!
  { JobName  = "ambulance", },
  { JobName  = "state"}
}
