...
function Initialize(scaleform)
    ...
    PushScaleformMovieFunctionParameterString("BENVENUTO SU WEIRD CITY ROLEPLAY ITALIA")
    PushScaleformMovieFunctionParameterString("PREMI CANC PER MAGGIORI INFORMAZIONI")
