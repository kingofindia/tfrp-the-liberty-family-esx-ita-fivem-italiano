...
AddEventHandler('esx_givecarkeys:setVehicleOwnedPlayerId', function (playerId, vehicleProps)
	...
	function (rowsChanged)
		TriggerClientEvent('esx:showNotification', playerId, 'Hai un nuovo veicolo con la targa: ~g~' ..vehicleProps.plate..'!', vehicleProps.plate)
...
TriggerEvent('es:addCommand', 'daichiavi', function(source, args, user)
TriggerClientEvent('esx_givecarkeys:keys', source)
end)
