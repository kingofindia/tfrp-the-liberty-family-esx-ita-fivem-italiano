...
function CreateBlip()
	if (PlayerData.job ~= nil and PlayerData.job.name == Config.nameJob) or (PlayerData.job2 ~= nil and PlayerData.job2.name == Config.nameJob) then
	...
	if (PlayerData.job ~= nil and PlayerData.job.name == Config.nameJob) or (PlayerData.job2 ~= nil and PlayerData.job2.name == Config.nameJob) and onDuty then
...
Citizen.CreateThread(function()
	while true do
		...
		if IsControlJustReleased(1, Keys["DELETE"]) and (PlayerData.job ~= nil and PlayerData.job.name == Config.nameJob) or (PlayerData.job2 ~= nil and PlayerData.job2.name == Config.nameJob) then
