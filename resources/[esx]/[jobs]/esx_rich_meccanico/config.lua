...
Config.Zones = {
	...
	MechanicActions = {
		Pos   = {x = -206.861, y = -1341.705, z = 33.904},
	...
	Garage = {
		Pos   = {x = -319.604, y = -131.888, z = 38.075},
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 27
	},
	...
	Craft = {
		Pos   = {x = -200.279, y = -1315.295, z = 30.109},
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 27
	},
	...
	VehicleSpawnPoint = {
		Pos   = {x = -224.618, y = -1289.302, z = 30.306},
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1
	},

	VehicleDeleter = {
		Pos   = {x = -191.06, y = -1296.188, z = 30.40},
