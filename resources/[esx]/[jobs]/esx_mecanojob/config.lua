...
Config.Zones = {
  MecanoActions = {
    Pos   = {x = -207.927, y = -1342.003, z = 33.894},
  ...
  Garage = {
    Pos   = {x = -212.071, y = -1340.092, z = 33.894},
    Size  = { x = 1.5, y = 1.5, z = 1.0 },
    Color = { r = 204, g = 204, b = 0 },
    Type  = 27,
  },
  ...
  Craft = {
    Pos   = {x = -200.863, y = -1315.289, z = 28.089},
    Size  = { x = 1.5, y = 1.5, z = 1.0 },
    Color = { r = 204, g = 204, b = 0 },
    Type  = 27,
  },
  ...
  VehicleSpawnPoint = {
    Pos   = {x = -164.541, y = -1302.736, z = 31.306},
    Size  = { x = 1.5, y = 1.5, z = 1.0 },
    Type  = -1,
  },

  VehicleDeleter = {
    Pos   = {x = -180.135, y = -1286.364, z = 30.296},
  ...
  VehicleDelivery = {
    Pos   = {x = -202.723, y = -1302.692, z = 30.296},
