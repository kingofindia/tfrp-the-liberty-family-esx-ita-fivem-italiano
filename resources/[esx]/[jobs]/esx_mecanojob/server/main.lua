...
AddEventHandler('esx_mecanojob:onNPCJobMissionCompleted', function()
  ...
  TriggerClientEvent("esx:showNotification", _source, _U('your_comp_earned').. societyMoney)
  TriggerClientEvent("esx:showNotification", _source, 'Hai guadagnato ~g~$ '.. playerMoney)
