...
ESX.RegisterServerCallback('esx_rich_chimico:requestDBItems', function(source, cb)
...
RegisterServerEvent('esx_rich_chimico:buyItem')
AddEventHandler('esx_rich_chimico:buyItem', function(label, itemName, price)
